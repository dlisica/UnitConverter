...
/**
 * 
 * API for converting measurement units. <br/>
 * Supported quantities: distance, area, volume, mass and time. <br/>
...
public class AppFrame extends JFrame {
	...
	String[] distanceValueArray = { "MILIMETAR", "CENTIMETAR", "DECIMETAR", "METAR", "KILOMETAR" };
	String[] areaValueArray = { "MILIMETAR KVADRATNI", "CENTIMETAR KVADRATNI", "DECIMETAR KVADRATNI", "METAR KVADRATNI", "KILOMETAR KVADRATNI" };
	String[] volumeValueArray = { "MILIMETAR KUBIČNI", "CENTIMETAR KUBIČNI", "DECIMETAR KUBIČNI", "METAR KUBIČNI", "KILOMETAR KUBIČNI" };
	String[] massValueArray = { "MILIGRAM", "GRAM", "KILOGRAM", "TONA" };
	String[] timeValueArray = { "MILISEKUNDA", "SEKUNDA", "MINUTA", "SAT" };
	
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			AppFrame frame = new AppFrame();
			frame.setLocation(400, 200);
			frame.setTitle("Pretvarač mjernih jedinica");
	 ...
	 * Input: number <br/>
	 * Output: number <br/>
	 * If input is not a number, output is "NEISPRAVAN UNOS" (invalid input). <br/>
	 * Possible problem: numerical error.
	 *
	 */
	...
	public AppFrame() {
		...
		JToggleButton distanceButton = new JToggleButton("UDALJENOST", true);
		JToggleButton areaButton = new JToggleButton("POVRŠINA");
		JToggleButton volumeButton = new JToggleButton("VOLUMEN");
		JToggleButton massButton = new JToggleButton("MASA");
		JToggleButton timeButton = new JToggleButton("VRIJEME");
		...
		JLabel inputLabel = new JLabel("UNOS", SwingConstants.CENTER);
		...
		JLabel outputLabel = new JLabel("REZULTAT", SwingConstants.CENTER);
		...
		//row9
		JLabel instructionsLabel1 = new JLabel("UPUTE: Za unos decimalnih brojeva koristite decimalnu točku, a za unos potencija koristite sljedeći zapis:");
		this.add(instructionsLabel1);
		
		//row10
		JLabel instructionsLabel2 = new JLabel("npr.: 1.604e5 što odgovara broju 1.604 * 10^5, odnosno 160500");
		...
		convertButton.addActionListener((l) -> {
			...
			try {
				...
				outputField.setText("NEISPRAVAN UNOS");
			}
